export const improvements: {
  ...
  "vaccine": [
    ...
    {
      name: "Костюм",
      desc: "Самый эффективный способ для борьбы, но супчик кушать сложно",
      price: 1500,
      count: 25,
  ...
  "scientists": [
    ...
    },
    {
      ...
      desc: "В течение 14 дней, люди находятся дома, это позволяет нам замедлить распространение вирус",
      price: 1000,
      count: 3,
